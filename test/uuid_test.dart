...
void main() {
  ...
  group('[Version 1 Tests]', () {
    test('IDs created at same mSec are different', () {
      expect(uuid.v1(options: {'mSecs': testTime}), isNot(equals(uuid.v1(options: {'mSecs': testTime}))));
    });
  ...
  group('[Version 6 Tests]', () {
    test('IDs created at same mSec are different', () {
      expect(uuid.v6(options: {'mSecs': testTime}), isNot(equals(uuid.v6(options: {'mSecs': testTime}))));
    });
  ...
  group('[Version 7 Tests]', () {
    test('IDs created at same mSec are different', () {
      expect(uuid.v7(options: {'mSecs': testTime}), isNot(equals(uuid.v7(options: {'mSecs': testTime}))));
    });
  ...
  group('[UuidValue]', () {
    ...
    test('Pass invalid Uuid to constructor', () {
      ...
      expect(() => UuidValue(invalidUUID, true), throwsA(isA<FormatException>()));
